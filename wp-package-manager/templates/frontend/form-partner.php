<?php
/**
 * Template: Partner Form
 * Path: templates/frontend/form-partner.php
 *
 * Renders fields defined in PM_Partner_Form::$fields.
 */
if ( ! defined( 'ABSPATH' ) ) {
    exit;
}
?>
<form id="pm-partner-form" class="pm-form" method="post" novalidate>
    <?php wp_nonce_field( 'pm_partner_nonce', 'nonce' ); ?>
    ...
    ?>
        <div class="pm-form-field pm-form-field-<?php echo $id; ?>">
            <?php if ( in_array( $type, ['text','email','tel'], true ) ) : ?>
